...
/**
 * AbstractCrmClass entity provides the base persistence definition of the
 * CrmClass entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractCrmClass implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractCrmClass() {
	}

	/** full constructor */
	public AbstractCrmClass(CrmCourseType crmCourseType, String name,
